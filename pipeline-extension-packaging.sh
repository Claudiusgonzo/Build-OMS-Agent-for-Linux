...
cd ${SOURCE_DIR}
pwsh ${SOURCE_DIR}/ev2/EV2VMExtnPackager.ps1 -outputDir ${OUTPUT_DIR}/ev2-artifacts -ExtensionInfoFile ${SOURCE_DIR}/ev2/extension-info.xml -BuildVersion ${OMS_EXTENSION_VERSION} -UseBuildVersionForExtnVersion -ReplaceBuildVersionInFileName

echo "ls -la ${OUTPUT_DIR}/ev2-artifacts"
ls -la ${OUTPUT_DIR}/ev2-artifacts
tree -f ${OUTPUT_DIR}/ev2-artifacts
